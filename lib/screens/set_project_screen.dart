...
class SetProjectScreen extends StatefulWidget {
  ...
  const SetProjectScreen({super.key});
...
Set<Circle> _circles = {};
CircleId currentCircleId = const CircleId('currentCircleId');
...
// region UI
  ...
  void getExistingProjects() async {
    await context.read<DataCubit>().queryAllProjects();
    allProjects = context.read<DataCubit>().state.projects;
